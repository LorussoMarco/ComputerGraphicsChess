...
public:
    ...
    /**
     * @brief Ottiene la trasformazione globale di un nodo.
     * @param node Nodo di cui calcolare la trasformazione globale.
     * @return Matrice di trasformazione globale del nodo.
     */
    static glm::mat4 getGlobalTransform(const std::shared_ptr<Node>& node);

    /**
     * @brief Ottiene la posizione globale di un nodo.
     * @param node Nodo di cui calcolare la posizione globale.
     * @return Vettore posizione globale del nodo.
     */
